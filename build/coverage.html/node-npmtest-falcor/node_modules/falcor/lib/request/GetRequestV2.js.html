...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-falcor/node_modules/falcor/lib/request/GetRequestV2.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-falcor/node_modules/falcor/lib/request/GetRequestV2.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-falcor/node_modules/falcor/lib/request/</a> &#187; GetRequestV2.js</div>
</div>
<div class="body">
 ...
 */
var GetRequestV2 = <span class="fstat-no" title="function not covered" >function(scheduler, requestQueue) {</span>
<span class="cstat-no" title="statement not covered" >    this.sent = false;</span>
<span class="cstat-no" title="statement not covered" >    this.scheduled = false;</span>
<span class="cstat-no" title="statement not covered" >    this.requestQueue = requestQueue;</span>
<span class="cstat-no" title="statement not covered" >    this.id = ++REQUEST_ID;</span>
<span class="cstat-no" title="statement not covered" >    this.type = GetRequestType;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this._optimizedPaths = [];</span>
<span class="cstat-no" title="statement not covered" >    this._requestedPaths = [];</span>
...
<span class="cstat-no" title="statement not covered" >    this._disposable = null;</span>
<span class="cstat-no" title="statement not covered" >    this._collapsed = null;</span>
<span class="cstat-no" title="statement not covered" >    this._disposed = false;</span>
};
&nbsp;
GetRequestV2.prototype = {
     ...
     */
    batch: <span class="fstat-no" title="function not covered" >function(requestedPaths, optimizedPaths, callback) {</span>
<span class="cstat-no" title="statement not covered" >        var self = this;</span>
<span class="cstat-no" title="statement not covered" >        var oPaths = self._optimizedPaths;</span>
<span class="cstat-no" title="statement not covered" >        var rPaths = self._requestedPaths;</span>
<span class="cstat-no" title="statement not covered" >        var callbacks = self._callbacks;</span>
<span class="cstat-no" title="statement not covered" >        var idx = oPaths.length;</span>
&nbsp;
        // If its not sent, simply add it to the requested paths
        // and callbacks.
<span class="cstat-no" title="statement not covered" >        oPaths[idx] = optimizedPaths;</span>
<span class="cstat-no" title="statement not covered" >        rPaths[idx] = requestedPaths;</span>
<span class="cstat-no" title="statement not covered" >        callbacks[idx] = callback;</span>
<span class="cstat-no" title="statement not covered" >        ++self._count;</span>
&nbsp;
        // If it has not been scheduled, then schedule the action
<span class="cstat-no" title="statement not covered" >        if (!self.scheduled) {</span>
<span class="cstat-no" title="statement not covered" >            self.scheduled = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            self._disposable = self._scheduler.schedule(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >                flushGetRequest(self, oPaths, <span class="fstat-no" title="function not covered" >function(err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >                    self.requestQueue.removeRequest(self);</span>
<span class="cstat-no" title="statement not covered" >                    self._disposed = true;</span>
&nbsp;
                    // If there is at least one callback remaining, then
                    // callback the callbacks.
<span class="cstat-no" title="statement not covered" >                    if (self._count) {</span>
<span class="cstat-no" title="statement not covered" >                        self._merge(rPaths, err, data);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                            var fn = callbacks[i];</span>
...
<span class="cstat-no" title="statement not covered" >        return createDisposable(self, idx);</span>
    },
&nbsp;
    /**
...
&nbsp;
     ...
     */
    _merge: <span class="fstat-no" title="function not covered" >function(requested, err, data) {</span>
<span class="cstat-no" title="statement not covered" >        var self = this;</span>
<span class="cstat-no" title="statement not covered" >        var model = self.requestQueue.model;</span>
...
<span class="cstat-no" title="statement not covered" >        var comparator = modelRoot.comparator;</span>
...
<span class="cstat-no" title="statement not covered" >        var nextPaths = flattenRequestedPaths(requested);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            setJSONGraphs(model, [{</span>
                paths: nextPaths,
...
// duplication.
<span class="fstat-no" title="function not covered" >function createDisposable(request, idx) {</span>
<span class="cstat-no" title="statement not covered" >    var disposed = false;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function flattenRequestedPaths(requested) {</span>
<span class="cstat-no" title="statement not covered" >    var out = [];</span>
<span class="cstat-no" title="statement not covered" >    var outLen = -1;</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, len = requested.length; i &lt; len; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        var paths = requested[i];</span>
<span class="cstat-no" title="statement not covered" >        for (var j = 0, innerLen = paths.length; j &lt; innerLen; ++j) {</span>
<span class="cstat-no" title="statement not covered" >            out[++outLen] = paths[j];</span>
        }
    }
